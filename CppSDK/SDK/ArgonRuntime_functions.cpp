...
class AFortAthenaMutator_Argon* UArgonTicketComponent::GetArgonMutator() const
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("ArgonTicketComponent", "GetArgonMutator");
...
void AFortAthenaMutator_Argon::FindSpawnLocationInSafeZone(struct FVector* InOutSpawnLocation) const
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("FortAthenaMutator_Argon", "FindSpawnLocationInSafeZone");
...
bool AFortAthenaMutator_Argon::IsInSafeZone(const struct FVector& TestLocation) const
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("FortAthenaMutator_Argon", "IsInSafeZone");
...
bool AFortAthenaMutator_Argon::ShouldShowNearbyTicketIndicators() const
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("FortAthenaMutator_Argon", "ShouldShowNearbyTicketIndicators");
