...
public:
	...
	struct FTransform                             DrawWorldOffset;                                   // 0x0010(0x0030)(Edit, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
public:
	...
	struct FFBIKDebugOption                       DebugOption;                                       // 0x0130(0x0050)(NoDestructor, NativeAccessSpecifierPublic)
	struct FRigUnit_FullbodyIK_WorkData           WorkData;                                          // 0x0180(0x0198)(Transient, NativeAccessSpecifierPublic)
