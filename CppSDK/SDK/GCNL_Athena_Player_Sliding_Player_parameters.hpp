...
public:
	...
	TDelegate<void(class AActor* SelfActor, class AActor* OtherActor, const struct FVector& NormalImpulse, const struct FHitResult& Hit)> K2Node_CreateDelegate_OutputDelegate; // 0x0020(0x0010)(ZeroConstructor, NoDestructor)
};
DUMPER7_ASSERTS_GCNL_Athena_Player_Sliding_Player_C_Initiate_Start_Audio;
...
DUMPER7_ASSERTS_GCNL_Athena_Player_Sliding_Player_C_OnApplicationGeneric;
...
DUMPER7_ASSERTS_GCNL_Athena_Player_Sliding_Player_C_SlideStopAudio;
