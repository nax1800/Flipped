...
public:
	...
	struct FHitResult                             CallFunc_K2_SetWorldLocation_SweepHitResult;       // 0x01E0(0x009C)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	TArray<class AFortPlayerController*>          Temp_object_Variable;                              // 0x0288(0x0010)(ConstParm, ReferenceParm)
	TArray<EFortTeamAffiliation>                  K2Node_MakeArray_Array;                            // 0x0298(0x0010)(ReferenceParm)
};
