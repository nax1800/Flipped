...
{
public:
	class UMotoSynthPreset*                       MotoSynthPreset;                                   // 0x06C0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_6CC[0x114];                                    // 0x06CC(0x0114)(Fixing Struct Size After Last Property [ Dumper-7 ])
