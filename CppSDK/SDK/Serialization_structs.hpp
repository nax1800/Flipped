...
public:
	...
	struct FStructSerializerBuiltinTestStruct     Builtins;                                          // 0x00F0(0x0090)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FStructSerializerArrayTestStruct       Arrays;                                            // 0x0180(0x0060)(NativeAccessSpecifierPublic)
	struct FStructSerializerMapTestStruct         Maps;                                              // 0x01E0(0x0140)(NativeAccessSpecifierPublic)
	struct FStructSerializerSetTestStruct         Sets;                                              // 0x0320(0x0140)(NativeAccessSpecifierPublic)
};
