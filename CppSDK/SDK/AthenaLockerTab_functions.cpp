...
void UAthenaLockerTab_C::UpdateInput(ECommonInputType InputType)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AthenaLockerTab_C", "UpdateInput");

	Params::AthenaLockerTab_C_UpdateInput Parms{};
