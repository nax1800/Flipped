...
DUMPER7_ASSERTS_Scoreboard_Team_Widget_C_GetWidgetForPlayerState;
...
{
public:
	struct FMinigameScoreboardPlayerRow           PlayerData;                                        // 0x0000(0x0040)(BlueprintVisible, BlueprintReadOnly, Parm)
	...
	class UScoreboard_UI_Row_C*                   CallFunc_Create_ReturnValue;                       // 0x0048(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UGridSlot*                              K2Node_DynamicCast_AsGrid_Slot;                    // 0x0058(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
DUMPER7_ASSERTS_Scoreboard_Team_Widget_C_MakePlayerRow;
...
DUMPER7_ASSERTS_Scoreboard_Team_Widget_C_UpdateMedalStanding;
...
public:
	...
	struct FMinigameScoreboardPlayerRow           CallFunc_Array_Get_Item_1;                         // 0x0090(0x0040)()
	...
	class UScoreboard_UI_Row_C*                   CallFunc_Array_Get_Item_2;                         // 0x0100(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
DUMPER7_ASSERTS_Scoreboard_Team_Widget_C_UpdateTeamData;
