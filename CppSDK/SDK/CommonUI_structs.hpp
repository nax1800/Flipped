...
public:
	...
	struct FSlateBrush                            OverrideBrush;                                     // 0x0020(0x00B0)(Edit, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FCommonInputTypeInfo                   KeyboardInputTypeInfo;                             // 0x0040(0x00D0)(Edit, Protected, NativeAccessSpecifierProtected)
	struct FCommonInputTypeInfo                   DefaultGamepadInputTypeInfo;                       // 0x0110(0x00D0)(Edit, Protected, NativeAccessSpecifierProtected)
	TMap<class FName, struct FCommonInputTypeInfo> GamepadInputOverrides;                            // 0x01E0(0x0050)(Edit, Protected, NativeAccessSpecifierProtected)
	struct FCommonInputTypeInfo                   TouchInputTypeInfo;                                // 0x0230(0x00D0)(Edit, Protected, NativeAccessSpecifierProtected)
};
